...
#include <Wire.h>
#include "Arduino.h"
/*CODEn command with respective DAC addr*/
...
public:
    ...
    */
    ...
    /*
    Init(Wire &I2cBus, bool A0, bool A1)     //cannot create Wire object
        {
            _I2CBUS = I2cBus;
            addr = 0x18 | (uint8_t)A0 << 1 | (uint8_t)A1 << 2; //Ajustar endereço
        }
    */

    Init(bool A0, bool A1)
    {
        addr = 0x81 | (uint8_t)A1 << 2 | (uint8_t)A0 << 1; //  0001 1000 or 0000 0(A1)0(R/W) or 0000 00(A0)(R/W)  
    }
    ...
    */
    ...
    //         ++idx;
    //     }
    //     miliVoltChannelA = (((_buf[0] & 0x0F) << 4) | ((_buf[1] & 0xF0) >> 4));
    //     idx = 0;
    //     /*Channel B*/
    //     Wire.beginTransmission(addr);
    //     Wire.write(dacBaddr);
    ...
    //         ++idx;
    //     }
    //     miliVoltChannelB = (((_buf[0] & 0x0F) << 4) | ((_buf[1] & 0xF0) >> 4));
    //     idx = 0;
    //     /*Channel C*/
    //     Wire.beginTransmission(addr);
    //     Wire.write(dacCaddr);
    ...
    //         ++idx;
    //     }
    //     miliVoltChannelC = (((_buf[0] & 0x0F) << 4) | ((_buf[1] & 0xF0) >> 4));
    //     idx = 0;
    //     /*Channel D*/
    //     Wire.beginTransmission(addr);
    //     Wire.write(dacDaddr);
    ...
    //         ++idx;
    //     }
    //     miliVoltChannelD = (((_buf[0] & 0x0F) << 4) | ((_buf[1] & 0xF0) >> 4));
    // }
