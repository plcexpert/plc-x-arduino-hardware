...
//PUBLIC METHODS
bool PlcX_Automation::Input(uint8_t InputNumber){
...
void PlcX_Automation::Output(uint8_t OutputNumber, bool NewState){
	digitalWrite(OutputNumber, NewState);	
}

bool PlcX_Automation::Output(uint8_t OutputNumber){
