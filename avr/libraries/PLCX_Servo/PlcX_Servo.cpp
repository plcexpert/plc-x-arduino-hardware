...
//
//=============================================================================
uint8_t PlcX_Servo::attach(uint8_t pin)
{
...
//
//=============================================================================
uint8_t PlcX_Servo::attach(uint8_t pin, uint16_t newMin, uint16_t newMax)
{
    myMin = newMin;
    myMax = newMax;
    return attach(pin);
...
//
//=============================================================================
void PlcX_Servo::write(uint16_t value)
{
    //make sure we have a valid servo number. If it's invalid then exit doing nothing.
...
//
//=============================================================================
void PlcX_Servo::writeMicroseconds(uint16_t value)
{
    //make sure we have a valid servo number. If it's invalid then exit doing nothing.
    if(myServoNumber == invalidServoNumber) return;
...
//
//=============================================================================
uint16_t PlcX_Servo::readMicroseconds()
{
    //make sure we have a valid servo number. If it's invalid then exit doing nothing.
    if(myServoNumber == invalidServoNumber) return 0;
...
//
//=============================================================================
long PlcX_Servo::map(long x, long in_min, long in_max, long out_min, long out_max)
{
